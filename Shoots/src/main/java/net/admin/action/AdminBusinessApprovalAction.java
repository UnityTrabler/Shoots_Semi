...
public class AdminBusinessApprovalAction implements Action {
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp)
		...
		int listcount = 0;
		listcount = dao.getBusinessListCount2(); //사용자 수를 가져온다
		list = dao.getBusinessList2(page, limit);	//사용자 리스트를 가져온다
		...
		if (state == null) {
			...
			forward.setPath("/WEB-INF/views/admin/adminBusinessApprovalList.jsp");
			return forward;
		} else {
