...
public class ReportAdd2Action implements Action {
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("reportType: " + req.getParameter("report_type"));
			System.out.println("match_id: " + req.getParameter("report_ref_id"));
            ...
            rb.setMatch_id(Integer.parseInt(req.getParameter("report_ref_id")));;
            
            int matchId = rb.getMatch_id();
            ...
            if (!result) {
    			...
    			out.print("location.href = '/Shoots/user/mypage';");
    			//out.print("location.href = '/Shoots/post/detail?num=" + matchId + "';");
    			out.print("</script>");
    			out.close();
