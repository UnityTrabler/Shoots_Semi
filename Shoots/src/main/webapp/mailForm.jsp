...
<body class="container mt-5 text-center">
		...
		<form class="form-horizontal" method="post" action="<%=request.getContextPath()%>/mailSend">			
			...
			<input type="email" name="receiver" id="receiver" class="form-control" placeholder="받는 주소" required>
		
			메일 제목<font color='red'>*</font>
			<input type="text" name="subject" id="subject" class="form-control" placeholder="email title 입력" required>
