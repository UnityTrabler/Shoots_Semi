...
<div id="regularContext">
			<form class="form-horizontal" method="post" action="updateProcess" id="signupform" enctype="multipart/form-data">
				...
				<div class="divBlock1">
				    ...
				    <input type="password" name="pwd" id="pwd" class="form-control" placeholder="pwd..." value="${userBean.password}">
				</div>
				...
				<div class="divBlock1" style="margin-left: 110px">
				    ...
				    <div class="row mb-3">
				        <div class="col">
				            <input type="text" id="RRN" name="RRN" class="form-control" placeholder="990101" maxlength="6" value="${userBean.RRN}">
				        </div>
				        <div class="col">
				            <span>-</span>
				        </div>
				        <div class="col d-flex align-items-center" style="padding: auto 0px;">
				            <input type="text" id="gender" name="gender" class="form-control" placeholder="" maxlength="1" style="width: 40px;" value="${userBean.gender}"> ****** 
				        </div>
				    </div>
				</div>
				...
				<div class="divBlock1">
					<div class="row" style="margin-left: 180px;">
					    ...
					    <input type="email" name="email" id="email" class="form-control col" placeholder="받는 주소" value="${userBean.email}" required >
